...
let print_test s f _ = Printf.printf s f ; ()

let rec run outch = function
  | TestCase f ->
      f () ; Printf.fprintf outch "\n"
  | TestList l ->
...
let main () =
  ...
  let connectivity =
    ...
    >::: [
           ( "  Average Degree"
           >:: fun _ -> Printf.fprintf outch "%.02f" (S.averageDegree gr) );
           ( "  Density"
           >:: fun _ -> Printf.fprintf outch "%0.5f" (S.density gr) );
           ( "  Zero-degree Packages"
           >:: fun _ ->
  ...
  let componentsSC =
    ...
    >::: [
           ...
           >:: fun _ -> Printf.fprintf outch "%d" (S.numberComponents scc) );
           ( "  Average Components SC"
           >:: fun _ -> Printf.fprintf outch "%0.2f" (S.averageComponents scc)
           );
           ( "  Larges Component SC"
           >:: fun _ -> Printf.fprintf outch "%d" (S.largestComponent scc) );
           ( "  Number of Components SC (zdp)"
           >:: fun _ -> Printf.fprintf outch "%d" (S.numberComponents scczdp)
           );
           ( "  Average Components SC (zpd)"
           >:: fun _ ->
  ...
  let componentsWC =
    ...
    >::: [
           ( "  Number of Components WC"
           >:: fun _ -> Printf.fprintf outch "%d" (S.numberComponents wcc) );
           ( "  Average Components WC"
           >:: fun _ -> Printf.fprintf outch "%0.2f" (S.averageComponents wcc)
           );
           ( "  Larges Component WC"
           >:: fun _ -> Printf.fprintf outch "%d" (S.largestComponent wcc) );
           ( "  Number of Components WC (zdp)"
           >:: fun _ -> Printf.fprintf outch "%d" (S.numberComponents wcczdp)
           );
           ( "  Average Components WC (zdp)"
           >:: fun _ ->
  ...
  let smallworld =
    ...
    >::: [
           ...
           >:: fun _ -> Printf.fprintf outch "%0.2f" (S.clustering gr) );
           ( "  Average Shortest Path Length"
           >:: fun _ ->
           Printf.fprintf outch "%0.2f" (S.averageShortestPathLength gr) );
           ( "  Average two step reach"
           >:: fun _ -> Printf.fprintf outch "%0.2f" (S.averageTwoStepReach gr)
           );
         ]
  in
  let centrality =
    ...
    >::: [
           ...
           >:: fun _ -> Printf.fprintf outch "%0.5f" (S.centralityOutDegree gr)
           );
           ( "  Centrality In Degree"
           >:: fun _ -> Printf.fprintf outch "%0.5f" (S.centralityInDegree gr)
           );
           ( "  Centrality Out Degree (zdp)"
           >:: fun _ ->
           Printf.fprintf outch "%0.5f" (S.centralityOutDegree zdpgr) );
           ( "  Centrality In Degree (zdp)"
           >:: fun _ ->
