...
let test_multiarch =
  "test multiarch"
  >::: [
         ( "multi arch same provide-conflicts"
         >:: fun _ ->
         (*
...
let test_conflicts =
  ...
  >::: [
         ...
         try
           ...
           assert_equal
             true
             (List.mem (ssmtp.Cudf.package, None) ssmtp.Cudf.conflicts)
         with Not_found -> assert_failure "ssmtp version mismatch" );
       ]
  ...
  [
    ...
    ( "66",
      ( "amd64",
        ...
        ( "foo",
          [],
          [[(false, "stage1"); (false, "nocheck")]; [(true, "nodoc")]] ) ),
      returns (Some "foo") );
    ( "67",
      ( "amd64",
        [],
    ...
    ( "90",
      ( "amd64",
        ...
        ( "foo",
          [],
          [[(true, "nodoc")]; [(false, "stage1"); (false, "nocheck")]] ) ),
      returns (Some "foo") );
    ( "91",
      ( "amd64",
        [],
