  ...
  try
    {
      ...
      preferences = Dose_pef.Packages.parse_s ~default:""
				Dose_pef.Packages.parse_string "preferences" par;
    }
...
class package ?(name=("package",None)) ?(version=("version",None)) ?(depends=("depends",None))
  ...
  inherit Dose_pef.Packages.package ~name ~version ~depends ~conflicts ~provides ~extras par
